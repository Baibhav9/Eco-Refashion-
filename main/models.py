...
from main.constants import ProductApprovalStatus, SellerProductCategory, UserProductCategory, TransactionStatus, \
    PaymentChoices
...
class Cart(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    product = models.ForeignKey("main.SellerProduct", on_delete=models.CASCADE)
